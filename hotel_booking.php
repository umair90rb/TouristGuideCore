...
$sql    	= 	"SELECT * FROM tbl_booking b, tbl_hotel_package p, tbl_hotel h, tbl_city c, tbl_tourist t
				 ...
				 b.user_id = t.user_id AND p.package_id=b.package_id AND p.hotel_id=h.hotel_id AND p.hotel_id=".$_SESSION['hotelId'];
					...
					?>
						<tr >
							...
							<td class="asome_fonts v_align" align="center" >
								<a href="http://localhost/Touristguide/Touristguide/hotel_process.php?bookingId=<?php echo $row['booking_id']?>">
