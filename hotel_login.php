...
<?php include('include/header.php');?>
   ...
   <div class="container">
        <div class="row" style="min-height:400px">
			...
			<form action="hotel_process.php" method="post" name="frmlogin" >
			 ...
			 <div class="col-md-offset-2 col-md-7">
					...
					<div class="row">
						...
						<div class="button">
							<p align="center">
                            <button type="submit" name="btnHotelLogin" class="btn btn-primary"> 
                            <i class="fa fa-arrow-right"></i>&nbsp;Hotel Login </button>&nbsp;
                            <button type="button" name="btnnback" class="btn btn-danger"> <i class="fa  fa-arrow-left"></i>&nbsp;Reset</button>
                            </p>
							<p>If you are new User Then Signup First <a  href="hotel_signup.php">SIGNUP</a></p>
     					</div>
						</div>	
					</div>
