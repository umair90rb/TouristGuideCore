...
<?php include('include/header.php');?>
	<!-- //header -->
    <div class="space"></div>
     <h2 align="center">Edit Tourist Information</h2>
   <div class="container-fluid">
		...
		<?php include('include/left-col-tourist.php');?>
  		...
  		<div class="col-md-8" >
				...
				<form name="frmEdit" action="tourist_process.php" method="post" >
				<input type="hidden" name="hidId" value="<?php echo $row['user_id'];?>" />
					...
					<div class="row">
						<div class="button">
							<p align="center">
                            <button type="submit" name="btnEditTourist" class="btn btn-primary"> <i class="fa fa-edit"></i>&nbsp;Edit Tourist Info </button>&nbsp;
