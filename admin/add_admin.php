...
<div class="container-fluid">
        ...
        <div class="row inner" style="height:400px;">
        	<h1 class="text-capitalize text-center"> Add New Admin</h1>
		<div class="col-md-offset-1 col-md-9 col-sm-8" >
                	<div style="padding-right:25px;">
				<form name="frmAdd" action="process_admin.php" method="post" >
					<div class="row">
						...
						<div class="col-md-9">
							<div style="margin-bottom: 25px" class="input-group">
								...
								<input type="text" class="form-control" name="txtName" placeholder="*Enter Admin Name" required>                                        
							</div>
						</div>
					</div>
					<div class="row">
					...
					<div class="row">
						...
						<div class="col-md-9">
							<div style="margin-bottom: 25px" class="input-group">
								...
								<input type="text" class="form-control" name="txtContact" placeholder="*Enter Phone Number" required>                                        
							</div>
						</div>
					</div>
					<div class="row">
					...
					<div class="row">
						<div class="button">
							<p align="center">
                            <button type="submit" name="btnAddAdmin" class="btn btn-primary"> <i class="fa fa-plus"></i>&nbsp;Add Admin</button>&nbsp;
